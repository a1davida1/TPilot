...
-- Description: Creates materialized views for analytics aggregation
-- Source: Extracted from PR #38 (add-analytics-metrics-aggregation-and-dashboard)
-- Created: 2025-10-28
...
-- Content Performance Daily View
-- Aggregates content views and social metrics by day
...
-- AI Usage Daily View
-- Aggregates AI generation counts and model usage by day
...
COMMENT ON MATERIALIZED VIEW analytics_content_performance_daily IS 'Daily aggregated content performance metrics including views, engagement, and social interactions';
COMMENT ON MATERIALIZED VIEW analytics_ai_usage_daily IS 'Daily aggregated AI generation counts and model usage breakdown';
