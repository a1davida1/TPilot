...
export function parseUTMFromCookie(cookieValue: string): UTMParams {
  try {
...
export function encodeUTMToCookie(params: UTMParams): string {
  return encodeURIComponent(JSON.stringify(params));
}

export function mergeUTMParams(cookieParams: UTMParams, queryParams: UTMParams): UTMParams {
...
export function getUTMCookieName(): string {
  return 'utm_params';
}

export function getUTMCookieMaxAge(): number {
