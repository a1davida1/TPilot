        ...
        <CardContent>
          <Tabs value={workflowMode} onValueChange={(v) => setWorkflowMode(v as 'text-first' | 'image-first')}>
            ...
            <TabsContent value="text-first" className="space-y-4 mt-6">
              ...
              {generatedContent && workflowMode === 'text-first' && (
            ...
            <TabsContent value="image-first" className="space-y-4 mt-6">
              <div className="space-y-4">
                ...
                {generatedContent && workflowMode === 'image-first' && (
                  <Card className="bg-gray-900/50 border-purple-500/20 animate-in fade-in duration-500">
                    <CardHeader>
