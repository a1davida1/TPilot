...
export function PolishedLoader({ text = "Loading..." }: { text?: string }) {
  return (
...
export function SuccessMessage({ 
  ...
  return (
    <Card className="glass border-green-200 bg-gradient-to-r from-green-50 to-emerald-50 hover-lift">
  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      {metrics.map((metric, index) => (
        <Card key={index} className="text-center hover-lift transition-all-smooth">
    ...
    <Card className={`border-2 border-orange-200 bg-gradient-to-r from-orange-50 to-yellow-50 ${className}`}>
      <CardContent className="p-6">
        <div className="flex items-center space-x-4">
          ...
          <Button 
            onClick={onUpgrade}
            className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white shadow-glow"
          >
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {stats.map((stat, index) => (
        <Card key={index} className="hover-lift transition-all-smooth group">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
