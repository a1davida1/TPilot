...
export default function PolicyDemo() {
  ...
  const loadExample = (type: 'clean' | 'warning' | 'blocked') => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl" data-testid="policy-demo-page">
      {/* Header */}
      ...
      <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="pt-4 border-t space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                <Button 
                  ...
                  data-testid="button-example-clean"
                >
                  Clean Content
                </Button>
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => loadExample('warning')}
                  className="text-yellow-600"
                  data-testid="button-example-warning"
                >
                  With Warnings
                </Button>
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={() => loadExample('blocked')}
                  className="text-red-600"
                  data-testid="button-example-blocked"
                >
                  Blocked Content
                </Button>
              </div>
        ...
        <div className="space-y-6">
          {showPreview && title && subreddit && (
            <PolicyPreview
              subreddit={subreddit}
              title={title}
              body={body}
              hasLink={hasLink}
              onPreviewComplete={handlePolicyPreviewComplete}
            />
          )}
