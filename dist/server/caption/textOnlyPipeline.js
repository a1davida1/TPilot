...
import { textModel } from "../lib/gemini.js";
...
export async function generateVariantsTextOnly(params) {
    ...
    if (Array.isArray(json)) {
        json.forEach((item) => {
            ...
            if (!item.caption || item.caption.length < 1)
                item.caption = "Check out this amazing content!";
        });
...
export async function rankAndSelect(variants, params) {
