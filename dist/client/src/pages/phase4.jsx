...
import { Zap, TrendingUp, Users, Target, Clock, MessageCircle, Brain, Sparkles, ArrowRight, CheckCircle, Star, Activity } from 'lucide-react';
export default function Phase4Dashboard() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            return (<Card key={index} className="bg-gradient-to-r from-gray-900/80 to-gray-800/80 border-gray-700/50 backdrop-blur-sm">
            ...
            return (<Card key={feature.id} className="bg-gradient-to-r from-gray-900/80 to-gray-800/80 border-gray-700/50 backdrop-blur-sm overflow-hidden">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button variant="outline" className="w-full border-gray-600 hover:border-purple-500 hover:bg-purple-500/10" onClick={() => setActiveTab(feature.id)} data-testid={`open-${feature.id}`}>
                        Open {feature.title}
            ...
            <Card className="bg-gradient-to-r from-gray-900/80 to-gray-800/80 border-gray-700/50 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                {aiInsights.map((insight, index) => (<div key={index} className="flex items-start space-x-4 p-4 rounded-lg bg-gray-800/30 border border-gray-700/50">
                    <div className={`p-2 rounded-lg ${insight.priority === 'high' ? 'bg-red-500/20 border border-red-500/30' :
                insight.priority === 'medium' ? 'bg-yellow-500/20 border border-yellow-500/30' :
                    'bg-blue-500/20 border border-blue-500/30'}`}>
                      <Star className={`h-4 w-4 ${insight.priority === 'high' ? 'text-red-400' :
            ...
            return (<div key={activity.id} className="flex items-center space-x-4 p-3 rounded-lg bg-gray-800/20 border border-gray-700/30">
