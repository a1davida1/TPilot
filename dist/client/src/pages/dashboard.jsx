...
export default function Dashboard() {
    ...
    const isRedditConnected = !!user?.reddit_username || !!user?.provider;
    return (<ModernDashboard user={user} userTier={userTier} isAdmin={isAdmin} isRedditConnected={isRedditConnected}/>);
}
