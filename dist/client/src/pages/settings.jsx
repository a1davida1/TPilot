...
import { Settings, User, Bell, Shield, CreditCard, Moon, Sun, Globe, Download, Trash2, Key, ArrowLeft, Crown, Zap } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            ...
            subscriptionData?.subscription?.plan || 'Free'} Plan
                ...
                <div className="text-right">
                  <Badge className={`mb-2 ${subscriptionData?.subscription?.plan === 'admin' ? 'bg-gradient-to-r from-red-600 to-orange-600 text-white' :
            ...
            subscriptionData?.subscription?.plan === 'free' ? 'Free' :
                subscriptionData?.subscription?.plan || 'Free'}
                  ...
                  <br />
                  {subscriptionData?.subscription?.plan !== 'admin' && (<Button onClick={handleUpgrade} className="bg-gradient-to-r from-purple-600 to-blue-600">
              ...
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-blue-600 h-2 rounded-full transition-all duration-300" style={{ width: `${(apiUsage.used / apiUsage.limit) * 100}%` }}></div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="outline" className="w-full justify-start" onClick={() => exportDataMutation.mutate()} disabled={exportDataMutation.isPending}>
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            ...
            'Card ending in •••• (managed by Stripe)'}
                  ...
                  {subscriptionData?.subscription?.plan !== 'free' && (<Button variant="outline" size="sm">
                      Update Card
                    </Button>)}
                </div>
          ...
          <div className="flex justify-end">
            <Button onClick={handleSaveSettings} disabled={updateSettingsMutation.isPending} className="bg-gradient-to-r from-purple-600 to-blue-600">
