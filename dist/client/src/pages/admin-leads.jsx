...
import { Search, Download, Users, CheckCircle, Clock, Filter, Mail, Calendar } from "lucide-react";
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <div className="relative flex-1">
                ...
                <Input placeholder="Search by email or pain point..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-10"/>
              </div>
          ...
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {filteredLeads.map((lead) => (<tr key={lead.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-wrap gap-1">
                          {lead.platformTags.map((platform) => (<Badge key={platform} variant="secondary" className={getPlatformColor(platform)}>
                              {platform}
                            </Badge>))}
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        {lead.confirmedAt ? (<Badge className="bg-green-100 text-green-800">
                            <CheckCircle className="mr-1 h-3 w-3"/>
                            Confirmed
                          </Badge>) : (<Badge variant="secondary" className="bg-amber-100 text-amber-800">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm">
                          ...
                          {lead.confirmedAt && (<div className="text-xs text-green-600 mt-1">
