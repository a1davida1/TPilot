...
import { Users, DollarSign, TrendingUp, Settings, Shield, Activity, Database, Eye, BarChart3, AlertCircle, CheckCircle, XCircle, Target, Smartphone, Calendar, VideoIcon, MessageSquare, Globe, Zap, Gift, Headphones, MonitorPlay, FileCheck } from 'lucide-react';
export function AdminDashboard() {
    ...
    return (<div className="min-h-screen bg-white text-gray-900 p-6">
      {/* Admin Header */}
      <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {adminStats.map((stat, index) => (<Card key={index} className="bg-white border-gray-200 hover:bg-gray-50 transition-all duration-300 shadow-lg">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className={`p-3 rounded-xl bg-gradient-to-br ${stat.color === 'text-blue-500' ? 'from-blue-500/20 to-blue-600/20' :
      ...
      <Tabs defaultValue="overview" className="space-y-6">
            ...
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {users?.slice(0, 5).map((user) => (<tr key={user.id} className="border-b border-white/5">
                        <td className="p-4">
                          <div>
        ...
        <TabsContent value="providers" className="space-y-6">
          <Card className="bg-white border-gray-200 shadow-lg">
            ...
            <CardContent>
              <div className="space-y-4">
                {providers?.map((provider) => (<div key={provider.name} className="p-4 bg-white/5 rounded-lg">
        ...
        <TabsContent value="analytics" className="space-y-6">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-white border-gray-200 shadow-lg">
              ...
              <CardContent>
                <div className="space-y-3">
                  {analytics?.topPages?.slice(0, 5).map((page, index) => (<div key={index} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
            ...
            <Card className="bg-white border-gray-200 shadow-lg">
              ...
              <CardContent>
                <div className="space-y-3">
                  {analytics?.trafficSources?.slice(0, 5).map((source, index) => (<div key={index} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
        ...
        <TabsContent value="status" className="space-y-6">
          <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="space-y-2">
                      ...
                      {Object.entries(completeness?.core || {}).map(([key, value]) => (<div key={key} className="flex items-center justify-between text-sm">
                    ...
                    <div className="space-y-2">
                      ...
                      {Object.entries(completeness?.features || {}).map(([key, value]) => (<div key={key} className="flex items-center justify-between text-sm">
                          <span className="text-gray-400 capitalize">{key.replace(/([A-Z])/g, ' $1')}</span>
                    ...
                    <div className="space-y-2">
                      ...
                      {Object.entries(completeness?.integrations || {}).map(([key, value]) => (<div key={key} className="flex items-center justify-between text-sm">
                          <span className="text-gray-400 capitalize">{key.replace(/([A-Z])/g, ' $1')}</span>
            ...
            <Card className="bg-white border-gray-200 shadow-lg">
              ...
              <CardContent>
                <div className="space-y-3">
                  <Button className="w-full justify-start bg-blue-100 hover:bg-blue-200 border-blue-300 text-blue-800" onClick={() => {
            toast({
                ...
                description: "Switch to Users tab to manage user accounts"
                  ...
                  <Button className="w-full justify-start bg-green-100 hover:bg-green-200 border-green-300 text-green-800" onClick={() => {
            toast({
                ...
                description: "View revenue metrics in Revenue tab"
                  ...
                  <Button className="w-full justify-start bg-purple-100 hover:bg-purple-200 border-purple-300 text-purple-800" onClick={() => {
            toast({
                title: "System Status",
                description: "Check system health in System tab"
                  ...
                  <Button className="w-full justify-start bg-pink-100 hover:bg-pink-200 border-pink-300 text-pink-800" onClick={() => {
            toast({
