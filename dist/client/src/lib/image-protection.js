...
export async function protectImage(imageFile, settingsOrLevel = 'standard', addWatermark = false) {
    ...
    return new Promise((resolve, reject) => {
        ...
        img.onload = () => {
            try {
                ...
                }, 'image/jpeg', (settings.quality || 85) / 100);
            }
            catch (error) {
                reject(error);
            }
...
export function downloadProtectedImage(blob, originalFileName) {
...
export function getProtectionPreview(level) {
