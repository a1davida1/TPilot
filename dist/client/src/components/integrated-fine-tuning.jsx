...
import { Save, Sparkles, Camera, Type, FileText, ChevronRight, Check } from "lucide-react";
...
export function IntegratedFineTuning() {
    ...
    const toggleSampleSelection = (sampleId) => {
        setSelectedSamples(prev => prev.includes(sampleId)
    ...
    return (<Card className="w-full bg-gray-900/50 backdrop-blur-xl border-white/10">
      <CardHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="samples" className="space-y-4">
            <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 rounded-lg p-4 border border-purple-500/20">
              ...
              <Textarea placeholder="Paste a sample post here..." className="min-h-[100px] bg-gray-800/50 border-white/10 text-white" onBlur={handleSampleUpload}/>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid gap-2 max-h-[300px] overflow-y-auto">
                {uploadedSamples.map((sample) => (<div key={sample.id} onClick={() => toggleSampleSelection(sample.id)} className={`p-3 rounded-lg border cursor-pointer transition-all ${selectedSamples.includes(sample.id)
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2 mt-2">
                          {sample.metadata?.platform && (<Badge variant="outline" className="text-xs">
                              {sample.metadata.platform}
                            </Badge>)}
                          {sample.metadata?.performance && (<Badge variant="outline" className="text-xs text-green-400">
                              {sample.metadata.performance}% engagement
                            </Badge>)}
                        </div>
                      </div>
                      <div className="ml-2">
                        {selectedSamples.includes(sample.id) ? (<Check className="h-5 w-5 text-purple-400"/>) : (<div className="h-5 w-5 border border-white/30 rounded"/>)}
                      </div>
                    </div>
                  </div>))}
              </div>
            ...
            <div className="flex justify-end">
              <Button onClick={() => setActiveTab("writing")} className="bg-purple-600 hover:bg-purple-700">
                Next: Writing Style
          ...
          <TabsContent value="writing" className="space-y-6">
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Slider value={[writingStyle.tone]} onValueChange={([value]) => setWritingStyle({ ...writingStyle, tone: value })} max={100} className="flex-1"/>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Slider value={[writingStyle.formality]} onValueChange={([value]) => setWritingStyle({ ...writingStyle, formality: value })} max={100} className="flex-1"/>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Slider value={[writingStyle.explicitness]} onValueChange={([value]) => setWritingStyle({ ...writingStyle, explicitness: value })} max={100} className="flex-1"/>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Textarea placeholder="e.g., confidence, empowerment, playfulness..." value={contentPreferences.themes} onChange={(e) => setContentPreferences({ ...contentPreferences, themes: e.target.value })} className="bg-gray-800/50 border-white/10 text-white"/>
              </div>

              <div>
                <Label className="text-white mb-2 block">Words/Phrases to Avoid</Label>
                <Textarea placeholder="Enter words or phrases you never want to use..." value={contentPreferences.avoid} onChange={(e) => setContentPreferences({ ...contentPreferences, avoid: e.target.value })} className="bg-gray-800/50 border-white/10 text-white"/>
              </div>
            </div>

            <div className="flex justify-between">
              <Button onClick={() => setActiveTab("samples")} variant="outline" className="border-white/20">
                Back
              </Button>
              <Button onClick={() => setActiveTab("visuals")} className="bg-purple-600 hover:bg-purple-700">
                Next: Visual Style
                <ChevronRight className="h-4 w-4 ml-2"/>
              </Button>
            </div>
          ...
          <TabsContent value="visuals" className="space-y-6">
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Slider value={[photoStyle.lighting]} onValueChange={([value]) => setPhotoStyle({ ...photoStyle, lighting: value })} max={100} className="flex-1"/>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Slider value={[photoStyle.mood]} onValueChange={([value]) => setPhotoStyle({ ...photoStyle, mood: value })} max={100} className="flex-1"/>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Slider value={[photoStyle.composition]} onValueChange={([value]) => setPhotoStyle({ ...photoStyle, composition: value })} max={100} className="flex-1"/>
            ...
            <div className="flex justify-between">
              <Button onClick={() => setActiveTab("writing")} variant="outline" className="border-white/20">
                Back
              </Button>
              <Button onClick={() => setActiveTab("review")} className="bg-purple-600 hover:bg-purple-700">
                Review & Save
                <ChevronRight className="h-4 w-4 ml-2"/>
              </Button>
            </div>
          ...
          <TabsContent value="review" className="space-y-6">
            <div className="bg-gradient-to-r from-green-900/20 to-blue-900/20 rounded-lg p-6 border border-green-500/20">
              ...
              <div className="space-y-3">
                ...
                {contentPreferences.themes && (<div className="flex justify-between items-center">
            ...
            <div className="flex justify-between">
              <Button onClick={() => setActiveTab("visuals")} variant="outline" className="border-white/20">
                Back
              </Button>
              <Button onClick={handleSaveAll} disabled={saveMutation.isPending} className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700">
