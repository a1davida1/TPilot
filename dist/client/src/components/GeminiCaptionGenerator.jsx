...
export function GeminiCaptionGenerator() {
    ...
    return (<div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Input type="url" placeholder="https://example.com/image.jpg" value={imageFile ? "" : imageUrl} onChange={(e) => setImageUrl(e.target.value)} disabled={!!imageFile}/>
          ...
          {/* Generate Button */}
          <Button onClick={handleGenerate} disabled={isGenerating || !imageUrl} className="w-full bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white">
            {isGenerating ? (<>
      ...
      {/* Caption Preview */}
      {captionData && (<div className="space-y-4">
