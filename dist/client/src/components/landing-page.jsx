...
import { Shield, Brain, Zap, Users, TrendingUp, CheckCircle, ArrowRight, Star, Target, Clock, Globe, BarChart3 } from "lucide-react";
...
export function LandingPage() {
    ...
    return (<div className="min-h-screen bg-white dark:bg-gray-900 overflow-hidden">
      {/* Fixed Header */}
      <header className="fixed top-0 w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-700/50 z-50">
        <nav className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          <div className="flex items-center gap-3 group cursor-pointer">
            <img src="/logo.png" alt="ThottoPilot" className="h-10 w-10 object-contain filter drop-shadow-lg group-hover:scale-110 transition-all duration-300"/>
      ...
      <section className="relative bg-gradient-to-br from-pink-500 via-rose-500 to-purple-600 text-white pt-24 pb-16 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {[...Array(12)].map((_, i) => (<div key={i} className="absolute bg-white/20 rounded-full animate-pulse" style={{
        ...
        <div className="relative max-w-6xl mx-auto text-center z-10">
          ...
          <div className="mb-8 flex justify-center">
            <img src="/logo.png" alt="ThottoPilot" className="h-24 w-24 md:h-32 md:w-32 object-contain filter drop-shadow-2xl transform hover:scale-105 transition-all duration-300"/>
          </div>
          ...
          <div className="flex gap-6 justify-center mb-16 flex-wrap">
            <Link to="/modern-demo">
              <Button size="lg" className="relative overflow-hidden bg-gradient-to-r from-yellow-400 to-yellow-300 text-gray-900 hover:from-yellow-300 hover:to-yellow-200 font-bold px-12 py-6 text-xl shadow-2xl hover:shadow-yellow-400/50 transition-all duration-300 hover:scale-110 border-2 border-yellow-200/50 group">
                <Zap className="mr-2 h-5 w-5"/>
                Try Demo - Free
              </Button>
            </Link>
            <Link to="/login">
              <Button size="lg" variant="outline" className="border-2 border-white/30 text-white hover:bg-white/10 font-bold px-8 py-4 text-lg backdrop-blur-sm transition-all duration-300">
      ...
      <section className="py-20 px-6 bg-gray-50 dark:bg-gray-800">
        ...
        ].map((feature, index) => (<Card key={index} className="bg-white dark:bg-gray-900 p-8 text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group">
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-gray-900 to-indigo-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-6 justify-center flex-wrap">
            <Link to="/modern-demo">
              <Button size="lg" className="bg-white text-indigo-600 hover:bg-gray-50 font-bold px-8 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                <Star className="mr-2 h-5 w-5"/>
                Start Free Trial
              </Button>
            </Link>
            <Link to="/login">
              <Button size="lg" variant="outline" className="border-2 border-white/30 text-white hover:bg-white/10 font-bold px-8 py-4 text-lg backdrop-blur-sm">
                Sign In
              </Button>
            </Link>
          </div>
