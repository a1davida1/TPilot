...
export function SEOOptimization({ title = "ThottoPilot - AI-Powered Content Creation Platform", description = "Create engaging Reddit posts with AI, protect your images from reverse searches, and optimize your content strategy for maximum engagement. Join thousands of successful creators.", keywords = ["content creation", "AI content generator", "Reddit posts", "image protection", "social media tools", "creator platform"], image = "/og-image.jpg", url = typeof window !== 'undefined' ? window.location.href : "https://thottopilot.com" }) {
    useEffect(() => {
