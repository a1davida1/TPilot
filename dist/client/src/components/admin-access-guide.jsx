...
export function AdminAccessGuide() {
    ...
    return (<Card className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border-purple-500/30">
      <CardHeader>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="bg-gray-900/50 rounded-lg p-3 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="sm" variant="ghost" onClick={() => copyToClipboard("admin@thottopilot.com", "Email")}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button size="sm" variant="ghost" onClick={() => copyToClipboard("admin123", "Password")}>
                  <Copy className="h-3 w-3"/>
                </Button>
              </div>
            </div>
        ...
        <div className="flex gap-3">
          <Button className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500" onClick={() => window.location.href = '/login'}>
            <LogIn className="h-4 w-4 mr-2"/>
            Go to Login
          </Button>
          
          <Button variant="outline" className="flex-1 border-purple-500/50" onClick={() => window.location.href = '/admin'}>
