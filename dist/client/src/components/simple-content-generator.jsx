...
import { Copy, Camera, Wand2, RefreshCw, CheckCircle } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { useMutation, useQueryClient } from "@tanstack/react-query";
import { apiRequest } from "@/lib/queryClient";
export function SimpleContentGenerator({ isGuestMode = false, onContentGenerated }) {
    ...
    return (<div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border-purple-500/30">
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={handleGenerate} disabled={generateContentMutation.isPending} className="w-full bg-gradient-to-r from-purple-500 to-pink-500">
      ...
      {generatedContent && (<div className="space-y-4 animate-in fade-in duration-500">
          {/* Generated Content */}
