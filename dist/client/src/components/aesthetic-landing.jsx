...
import { Sparkles, Brain, Shield, TrendingUp, Star, Check, Lock, Users, Eye, DollarSign, Target, Crown } from "lucide-react";
        ...
        <header className="fixed top-0 w-full bg-black/50 backdrop-blur-xl border-b border-white/10 z-50">
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Button variant="ghost" className="text-gray-300 hover:text-white" onClick={() => window.location.href = '/login'}>
                Sign In
              </Button>
              ...
              <CardContent className="p-0">
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <TabsList className="w-full bg-gray-900/50 border-b border-white/10 rounded-none">
                    <TabsTrigger value="generate" className="flex-1 data-[state=active]:bg-purple-600/20 data-[state=active]:text-purple-300">
                      <Brain className="mr-2 h-4 w-4"/>
                      AI Generator
                    </TabsTrigger>
                    <TabsTrigger value="protect" className="flex-1 data-[state=active]:bg-purple-600/20 data-[state=active]:text-purple-300">
                      <Shield className="mr-2 h-4 w-4"/>
                      Image Protection
                    </TabsTrigger>
                    <TabsTrigger value="analytics" className="flex-1 data-[state=active]:bg-purple-600/20 data-[state=active]:text-purple-300">
                    ...
                    <TabsContent value="generate" className="mt-0">
                      <div className="grid lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2">
                          <EnhancedAIGenerator isGuestMode={true} onContentGenerated={() => { }}/>
                        </div>
                        <div className="space-y-4">
                          ...
                          <Button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700" onClick={() => window.location.href = '/login'}>
        ...
        <section className="py-20 border-t border-white/10">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (<Card key={index} className="bg-gray-900/50 border-white/10 hover:border-purple-500/50 transition-all hover:-translate-y-1 card-hover-glow">
                  <CardHeader>
