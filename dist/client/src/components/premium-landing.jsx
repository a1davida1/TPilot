...
import { Sparkles, Brain, Shield, TrendingUp, Users, Star, Check, ArrowRight, Zap, Target, Eye, DollarSign } from "lucide-react";
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button size="lg" className="btn-premium text-lg px-8 py-4 h-auto shadow-glow" onClick={() => document.getElementById('signup-section')?.scrollIntoView({ behavior: 'smooth' })}>
                    <Zap className="mr-2 h-5 w-5"/>
                    Start Creating Free
                    <ArrowRight className="ml-2 h-5 w-5"/>
                  </Button>
                  
                  <Button variant="outline" size="lg" className="border-2 border-white/20 text-white hover:bg-white/10 text-lg px-8 py-4 h-auto" onClick={() => window.location.href = '/dashboard?guest=true'}>
                ...
                <div className="flex items-center space-x-6 text-sm text-gray-400">
                  <div className="flex items-center space-x-2">
                    <div className="flex -space-x-1">
                      {[1, 2, 3, 4].map((i) => (<div key={i} className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 border-2 border-white/20"/>))}
                    </div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {features.map((feature, index) => (<Card key={index} className="glass border-white/20 hover-lift transition-all-smooth group">
                  <CardHeader>
                  ...
                  <div className="flex items-center justify-center space-x-3">
                    ...
                    <div className="text-left">
                      <div className="font-semibold text-white flex items-center">
                        ...
                        {testimonials[currentTestimonial].verified && (<Check className="ml-2 h-4 w-4 text-green-400"/>)}
                      </div>
            ...
            <Card className="glass border-white/20 p-12 hover-glow">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="btn-premium text-lg px-12 py-4 h-auto shadow-glow-pink" onClick={() => document.getElementById('signup-section')?.scrollIntoView({ behavior: 'smooth' })}>
