...
import { Sparkles, Shield, Brain, TrendingUp, ArrowRight, Star, Calendar, Target, BarChart3, DollarSign, Crown, Play } from "lucide-react";
    ...
    return (<div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-32 w-80 h-80 rounded-full bg-gradient-to-br from-purple-400/20 to-pink-400/20 blur-3xl" style={{ transform: `translate(${scrollY * 0.3}px, ${scrollY * 0.1}px)` }}/>
          <div className="absolute -bottom-40 -left-32 w-80 h-80 rounded-full bg-gradient-to-br from-blue-400/20 to-cyan-400/20 blur-3xl" style={{ transform: `translate(${-scrollY * 0.2}px, ${-scrollY * 0.1}px)` }}/>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button size="lg" variant="outline" onClick={handleDemoAccess} className="font-semibold text-lg px-8 py-4 border-2">
            ...
            <div className="flex justify-center items-center gap-8 text-sm text-gray-500 dark:text-gray-400 mb-16">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (<div key={i} className="w-8 h-8 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full border-2 border-white"/>))}
                </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        ...
        ].map((feature, index) => (<Card key={index} className="relative overflow-hidden hover:shadow-xl transition-all duration-300 group">
                {feature.badge && (<Badge className={`absolute top-4 right-4 bg-gradient-to-r ${feature.gradient} text-white border-none text-xs`}>
                    {feature.badge}
                  </Badge>)}
                <CardHeader>
      ...
      <section className="py-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" onClick={handleDemoAccess} className="border-white text-white hover:bg-white/10 font-semibold text-lg px-8 py-4">
              Try Demo
