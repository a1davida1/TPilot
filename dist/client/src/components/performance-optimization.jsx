...
export const PerformanceOptimization = memo(() => {
    ...
    const performanceScore = Math.round((100 - (metrics.loadTime / 50)) * 0.3 +
    ...
    return (<Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          ...
          <Button variant="outline" size="sm" onClick={autoOptimize} disabled={isOptimizing} className="flex items-center">
            {isOptimizing ? (<RefreshCw className="h-4 w-4 mr-1 animate-spin"/>) : (<Zap className="h-4 w-4 mr-1"/>)}
