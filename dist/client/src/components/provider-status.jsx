    ...
    return (<Card>
      ...
      <CardContent>
        <div className="space-y-4">
          {safeArray(providers, []).map((provider, index) => {
            ...
            return (<div key={providerName + index} className="flex items-center justify-between p-4 border rounded-lg">
          ...
          {safeArray(providers, []).length === 0 && (<div className="text-center py-8 text-gray-500">
