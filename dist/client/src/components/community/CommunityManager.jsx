...
import { Users, MessageCircle, Heart, Reply, TrendingUp, Shield, CheckCircle, Search, Filter, Bell, Star } from 'lucide-react';
      ...
      <Tabs defaultValue="communities" className="space-y-4">
        ...
        <TabsContent value="communities" className="space-y-4">
          ...
          <div className="grid gap-4">
            {communities.map((community) => (<Card key={community.id} className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 border-gray-700/50">
                <CardHeader className="flex flex-row items-center justify-between space-y-0">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge variant="outline" className={`border-gray-600 ${getActivityColor(community.activity)}`}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                      {community.bestTimes.map((time, index) => (<Badge key={index} variant="secondary" className="text-xs bg-purple-500/20 text-purple-300">
                          {time}
                        </Badge>))}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge variant="outline" className={community.rules === 'verified' ? 'border-green-500 text-green-400' :
        ...
        <TabsContent value="engagement" className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <Input placeholder="Search engagements..." className="pl-10 bg-gray-900/50 border-gray-700" data-testid="search-engagements"/>
              </div>
              <div className="flex items-center space-x-2">
                <Filter className="h-4 w-4 text-gray-400"/>
                {['all', 'comments', 'dms', 'mentions'].map((filter) => (<Badge key={filter} variant={selectedFilter === filter ? 'default' : 'outline'} className={`cursor-pointer capitalize ${selectedFilter === filter
                ? 'bg-purple-500 hover:bg-purple-600'
                : 'border-gray-600 hover:border-purple-500'}`} onClick={() => setSelectedFilter(filter)} data-testid={`filter-${filter}`}>
                    {filter}
                  </Badge>))}
              </div>
            </div>
          ...
          {/* Engagement List */}
          <div className="grid gap-4">
            {engagements.map((engagement) => (<Card key={engagement.id} className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 border-gray-700/50">
                <CardHeader className="flex flex-row items-center justify-between space-y-0">
                  <div className="flex items-center space-x-3">
                    <div className="p-2 rounded-lg bg-purple-500/20">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      {engagement.replied && (<div className="flex items-center space-x-1">
        ...
        <TabsContent value="auto-reply" className="space-y-4">
          ...
          <Card className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 border-gray-700/50">
            <CardHeader className="flex flex-row items-center justify-between space-y-0">
              ...
              <Switch checked={autoReplyEnabled} onCheckedChange={setAutoReplyEnabled} data-testid="switch-auto-reply"/>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          {/* Reply Templates */}
          <div className="grid gap-4">
            {autoReplyTemplates.map((template) => (<Card key={template.id} className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 border-gray-700/50">
                <CardHeader className="flex flex-row items-center justify-between space-y-0">
                  <div>
                  ...
                  <Switch checked={template.enabled} onCheckedChange={() => { }} data-testid={`switch-template-${template.id}`}/>
                </CardHeader>
                <CardContent className="space-y-3">
          ...
          <Card className="bg-gradient-to-r from-gray-900/50 to-gray-800/50 border-gray-700/50">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input placeholder="e.g., outfit, where to buy, collaboration" className="bg-gray-900/50 border-gray-700" data-testid="input-trigger-keywords"/>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-300">Reply Template</label>
                <Textarea placeholder="Enter your reply template..." className="bg-gray-900/50 border-gray-700 min-h-[100px]" data-testid="textarea-reply-template"/>
              </div>
