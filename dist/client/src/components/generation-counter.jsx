...
export function GenerationCounter({ className }) {
    const { user } = useAuth();
    ...
    return (<Card className={`border-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 ${className}`} data-testid="generation-counter">
      <CardContent className="p-3">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            {!isUnlimited && (<Progress value={progressPercentage} className="w-16 h-1 mt-1"/>)}
          </div>
        </div>
        
        {isAtLimit && (<div className="text-xs text-destructive mt-1">
