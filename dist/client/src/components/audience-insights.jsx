...
export function AudienceInsights() {
    ...
    const audienceData = insightsData?.audienceData || [];
      ...
      <Card className="bg-gray-900/50 backdrop-blur-xl border-white/10">
        ...
        <CardContent>
          <div className="space-y-4">
            {audienceData.map((platform) => (<div key={platform.platform} className="p-4 bg-white/5 rounded-lg">
                ...
                <div className="mt-3 flex flex-wrap gap-1">
                  {platform.demographics.interests.map((interest) => (<Badge key={interest} variant="secondary" className="text-xs">
                      {interest}
                    </Badge>))}
                </div>
              </div>))}
      ...
      <Card className="bg-gray-900/50 backdrop-blur-xl border-white/10">
        ...
        <CardContent>
          <div className="space-y-3">
            {topSubreddits.map((subreddit, index) => (<div key={subreddit.name} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
      ...
      <Card className="bg-gray-900/50 backdrop-blur-xl border-white/10">
        ...
        <CardContent>
          <div className="grid grid-cols-7 gap-2 text-xs">
            {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day) => (<div key={day} className="text-center">
